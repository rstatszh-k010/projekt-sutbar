...
```{r}
# Summe der Anzahl gewählter Frauen aller Kantone und Parteien
...
# Anzahl gewählte Frauen (mit gt und einer function(x)):
...
```{r}
# Entwicklung des Frauen-Anteils auf nationaler Ebene für die Bundesratsparteien plus die Grünen und die GLP
...
NRW2023_zeitreihe_CH |> 
 mutate(partei_bezeichnung_de = case_when(
  ...
  # frauen_anteil hat ein NA für 2023 und CVP aufgrund der Umbenennung. Dies ist der Grund dafür, dass die Punkte nicht verbunden werden. NA herausfiltern und es passt.
