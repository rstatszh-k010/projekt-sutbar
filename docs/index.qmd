...
# Pfad zur CSV-Datei
$csvPfad = "C:\Pfad\zu\deinerDatei.csv"

# CSV einlesen mit Semikolon als Trennzeichen
$daten = Import-Csv -Path $csvPfad -Delimiter ";"

# Ausgabe der eingelesenen Daten (optional)
$daten
...
```{r}
NRW2023_zeitreihe <- read_csv(here::here("daten/raw/sd-t-17.02-NRW2023-zeitreihen-parteien-APPENDIX (1).csv", delimiter=";"))


import pandas as pd
df = pd.read_csv('datei.csv', delimiter=';')
print(df.head())
...
```{r}
glimpse(zeitreihen_parteien)

names(zeitreihen_parteien)

nrow(zeitreihen_parteien)
