...
Im Rahmen einer Weiterbildung des Kantons Zürich - Data Science mit R - wird vertieften Einblick in die Anwendung von R ermöglicht. Als Abschlussprojekt des Kurses wird ein OGD-Datensatz verwendet um den vermittelten Einblick direkt an einem eigenen Projekt anzuwenden und zu vertiefen.
...
## Tabelle: Parteistärke runden auf 2 Kommastellen und sortieren nach Grösse!
...
# Es wird eine Visualisierung erstellt, bei welcher man die Verteilung der Parteien nach Parteienstärke auf einen Blick sieht
...
1.  Wie verhält sich die Parteienstärke bei den Nationalratswahlen 2023?
    ...
    -   Bei den NRW 2023 geht die SVP als klar stärkste Partei aus den Wahlen und liegt deutlich vor der SP. Danach positioniert sich die FDP an dritter Stelle knapp vor der Mitte.
